...
let emp = createEmployeeRecord(['Kyle', "Hartson", 'Dev', 15]);
console.log(emp);
createTimeInEvent(emp, '2021-11-18 0900'); 
createTimeOutEvent(emp, '2021-11-18 1100');
console.log(wagesEarnedOnDate(emp, '2021-11-18'));  